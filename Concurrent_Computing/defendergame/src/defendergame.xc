...
void userAnt(chanend fromButtons, chanend toVisualiser, chanend toController) {
  ...
  while (1) {
    ...
    if (buttonInput == 13) userAntPosition--;
    if (buttonInput == 14) userAntPosition++;
    if ((userAntPosition == 22) && (userAntPosition == 4294967295)) userAntPosition = 0;
    ////////////////////////////////////////////////////////////
    //
    // !!! place code here for userAnt behaviour
    //
    /////////////////////////////////////////////////////////////
    toVisualiser <: (userAntPosition % 23);
  }
}
...
void attackerAnt(chanend toVisualiser, chanend toController) {
  ...
  //
  /////////////////////////////////////////////////////////////
      if ((attackerAntPosition == 23)) attackerAntPosition = 0;
      if (attackerAntPosition == 4294967295) attackerAntPosition = 22;
